...
export default function Edit({ auth, quiz, layout }) {
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        code_template: quizData.code_template,
    });

    const submit = (e) => {
        e.preventDefault();
        put(route('admin.quizzes.update', quizData.id));
    };
                    ...
                    <div className="bg-white dark:bg-gray-600 overflow-hidden shadow-sm sm:rounded-lg">
                        <form onSubmit={submit} className="p-6 text-gray-900 dark:text-white">
                            ...
                            <div className="flex space-x-4">
                                ...
                                <Link
                                    href={route('admin.quizzes.show', quizData.id)}
                                    className="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded"
                                >
                                    Cancel
                                </Link>
